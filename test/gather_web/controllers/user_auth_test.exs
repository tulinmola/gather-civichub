defmodule GatherWeb.UserAuthTest do
  use GatherWeb.ConnCase, async: true

  alias Gather.Accounts
  alias GatherWeb.UserAuth
  import Gather.AccountsFixtures

  @remember_me_cookie "_gather_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, GatherWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      GatherWeb.Endpoint.subscribe(live_socket_id)
